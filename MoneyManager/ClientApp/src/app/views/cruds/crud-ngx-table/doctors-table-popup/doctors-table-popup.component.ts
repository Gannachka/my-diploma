...
@Component({
  selector: 'app-doctors-table-popup.component',
  templateUrl: './doctors-table-popup.component.html'
})
export class DoctorsTablePopupComponent implements OnInit, OnDestroy {
  ...
  constructor(
    ...
    public dialogRef: MatDialogRef<DoctorsTablePopupComponent>,
